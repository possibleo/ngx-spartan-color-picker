...
import { HlmColorPickerPanel } from 'ngx-spartan-color-picker';

@Component({
  selector: 'site-hero',
  imports: [HlmButton, HlmColorPickerPanel, NgIcon, RouterLink],
  changeDetection: ChangeDetectionStrategy.OnPush,
  template: `
    <section class="site-container relative z-10 pb-24 pt-12 lg:pt-20" aria-labelledby="hero-heading">
      <div class="grid items-start gap-12 lg:grid-cols-2 lg:gap-16">
        <div class="max-w-lg">
          <p class="site-kicker animate-fade-up">For Spartan NG</p>
          <h1 id="hero-heading" class="site-heading animate-fade-up animate-delay-1 mt-3">
            A color picker that fits your
            <span class="hero-accent" [style.color]="heroColor()">Spartan</span>
            stack
          </h1>
          <p class="site-lead animate-fade-up animate-delay-2 text-base sm:text-lg">
          ...
          <p class="text-muted-foreground animate-fade-up animate-delay-2 mt-3 text-sm">
        ...
        <div class="animate-fade-up animate-delay-2 lg:justify-self-end lg:pt-2">
          <div class="site-card w-fit max-w-full">
            ...
            <hlm-color-picker-panel [(value)]="heroColor" [alpha]="true" />
          </div>
        </div>
      </div>
    </section>
